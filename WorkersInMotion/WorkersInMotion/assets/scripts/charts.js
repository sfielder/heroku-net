var Charts = function () {
    ...
    return {
        ...
        initBarCharts: function (data) {
            ...
            var data1 = [];
            for (var x = 0; x < parsed.length; x = x + 2) {
                //alert([parsed[x] + 1] + ',' + [parsed[x + 1] + 100]);
                data1.push([parsed[x] + 1, parsed[x + 1]]);
            }
            var data = data1;
            //console.log(data);
            var options = {
        ...
        initPieCharts: function (data, series) {
                    ...
                    pie: {
                        ...
                        label: {
                            ...
                            formatter: function (label, series) {
                                ...
                                if (label == "None") {
                                    return '<div style="font-size:8pt;text-align:center;padding:2px;color:black;">' + label + '<br/></div>';
                                }
                                else {
