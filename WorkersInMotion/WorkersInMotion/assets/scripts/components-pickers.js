var ComponentsPickers = function () {
    ...
    var ControllerCall = function (controllername, fromdate, todate) {
        ...
        if (controllername == "StoreVisit") {
            ...
            var str = document.location.toString().substring(0, document.location.toString().indexOf('?'));
            
            if (str !== '') {
                var qstr = document.location.toString().replace(str, '');

                window.location.href = "/" + controllername + "/Index" + qstr + "&" + id + "&FromDate=" + fromdate + "&ToDate=" + todate + "&Date=" + $('#reportrange span').html();
            }
            else
            ...
            if (str !== '') {
                ...
                window.location.href = "/" + controllername + "/Index" + qstr + "&FromDate=" + fromdate + "&ToDate=" + todate + "&Date=" + $('#reportrange span').html();
            }
            else
                window.location.href = "/" + controllername + "/Index?FromDate=" + fromdate + "&ToDate=" + todate + "&Date=" + $('#reportrange span').html();
        }
